...
describe("Test handleLockOrder", () => {
    describe("Test getRoute", () => {
        ...
        // createMovePalletInstructions
        context("Order type: movePallet", () => {
            ...
            context("Test getRoute when vertices are visited more than once", () => {
        ...
        context("Order type: moveForklift", () => {
            ...
            data.addOrder(new Order(fourthOrderId, Order.types.moveForklift, fourthForkliftId, "P4", vertexIdFourthRoute[0], vertexIdFourthRoute[vertexIdFourthRoute.length - 1], visitTimes[0][3], Order.timeTypes.start, 3));
            ...
            context("Test for one scheduleItem at each vertex in the route", () => {
                ...
                // let expectedRoute = createMoveForkliftRoute(routeScheduler, firstOrder, vertexIdFirstRoute, "RO1", firstForkliftId, visitTimes[0]);
